-- Repair: 0007's pairing-schedule RPCs referenced a non-existent cron.job
-- column (next_run_at) and built zero-padded cron expressions ("03 30 * * 3")
-- which pg_cron rejects. Redefine both functions correctly (idempotent).
